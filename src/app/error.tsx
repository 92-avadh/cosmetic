...
export default function ErrorBoundary({
  ...
  useEffect(() => {
    // Log the error securely to backend or console
  ...
  return (
    <div className="fixed inset-0 z-50 bg-[#121212] flex flex-col items-center justify-center text-[#F6F4EE] px-6 select-none text-center">
      ...
      <div className="relative z-10 max-w-lg flex flex-col items-center">
        ...
        {/* Dynamic sanitized error description */}
        <div className="w-full bg-[#F6F4EE]/5 border border-[#F6F4EE]/10 rounded-lg p-4 mb-8 font-mono text-[10px] sm:text-xs text-left max-h-40 overflow-y-auto text-[#F6F4EE]/70 custom-scrollbar">
