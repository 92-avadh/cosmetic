...
export const metadata: Metadata = {
  title: "About Us",
  description:
    "BODYBARREL's genesis, clinical advisory board, and green-tech cold extraction philosophy. Body wash science for whole-body skin fitness.",
  openGraph: {
    title: "About Us | BODYBARREL",
    description:
      "BODYBARREL's genesis, clinical advisory board, and green-tech cold extraction philosophy.",
    url: `${SITE_URL}/us`,
    images: [{ url: "/products/us-narrative.png", width: 1200, height: 630, alt: "About BODYBARREL" }],
  },
};
