                  ...
                  >
                    <div className="flex gap-4 items-center">
                      <div className="w-20 h-24 bg-card-bg border border-line rounded-lg overflow-hidden shrink-0 relative aspect-[3/4]">
                        <img src={item.image.includes(",") ? item.image.split(",")[0] : item.image} alt={item.name} width={80} height={96} loading="lazy" decoding="async" className="w-full h-full object-cover" />
                      </div>
