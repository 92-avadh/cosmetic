...
export const POST = withApiHandler(async (request: Request) => {
  ...
  try {
    await sendEmail({
      to: email,
      subject: "Welcome to BODYBARREL — Body Wash Science",
      html: `
        <div style="font-family: sans-serif; max-width: 520px; margin: 0 auto; padding: 30px; border: 1px solid #eaeaea; border-radius: 12px; background: #fff;">
          ...
          <p style="font-size: 13px; color: #555; line-height: 1.7; margin-top: 16px;">Explore our full range of cellular body care at <a href="https://bodybarrel.com/shop" style="color: #C97A5E; text-decoration: none; font-weight: 600;">bodybarrel.com/shop</a>.</p>
