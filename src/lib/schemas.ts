...
export const productCreateSchema = z.object({
  ...
  salePriceUSD: z.number().nonnegative("Sale price must be 0 or positive").default(0),
...
export const productUpdateSchema = z.object({
  ...
  salePriceUSD: z.number().nonnegative("Sale price must be 0 or positive").optional(),
